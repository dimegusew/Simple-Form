...
Тестовое задание для школы Яндекс Node.js
Необходимо было реализовать html-страницу с разметкой, логикой поведения и предоставлением глобального js-объекта с методами, описанными в п.1,2,3
...
UPD: Вданном проекте выполняются запросы на статические файлы с разными подготовленными вариантами ответов. Так как браузер Google Chrome запрещает запросы на статичиские файлы, тестирование проводилось в браузере Mozilla Firefox 54.0.1 (32-бит)